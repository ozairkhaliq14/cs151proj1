...
function setup() {
    ...
    alert("The Formal atristic elements of this piece are Distortion, Pattern and symmetry. For this piece, the user is able to control the size, position, rotation, rotation speed, and rotaion angles. The following keys are binded to their respective acitons: \n  Drag in all 4 ways while holding Left click to get the panning affect. \n  Drag in all 4 ways while holding Right click to zoom in and out both vertically and horizontally. \n  X - Rotate the cylinder over the X axis  \n  Y - Rotate the cylinder over the Y axis \n Z - Rotate the cylinder over the Z axis \n A - Rotate the cylinder over all three axis \n F - Rotate the cylinder over all three axis at speed of frameCount * 0.01 \n Enter - Clear existing lines/distortions. \n");
}
